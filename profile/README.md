...
- **Reliable timing and trigger-driven.** Configure a device ahead of time; it then acts on an edge in its own clock. Timing-critical parts are offloaded to dedicated hardware.
